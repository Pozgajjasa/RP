...
- Ukaz za hitro preklapljanje med aplikacijami: ```Alt + Tab```   
- Ukaz za odpiranje ukazne vrstice (Command Palette) v programu: ```Ctrl + Shift + P```
- Ukaz za shranjevanje trenutnega dokumenta ali datoteke: ```Ctrl + S```

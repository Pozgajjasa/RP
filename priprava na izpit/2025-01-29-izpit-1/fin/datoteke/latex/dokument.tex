...
% naslov
% povzetek
\title{Dinamika demokratskih izborov: Galamov model}
\author{Matej Rojec}
\date{2.~februar~2025}
...
Leta 2016 je Galam objavil študijo~\cite{galam2016trump}, ki je pojasnila nepričakovano zmago Donalda Trumpa na 
...
\begin{figure}[ht!]
    ...
    \caption{Analiza verjetnosti za različne vrednosti $r$.}
    \label{fig:grafi}
\end{figure}

...
% S tem ukazom lahko izpišete en spletni naslov tako, da
% naslov podate kot argument ukaza `\url` v zavitih oklepajih.
% V spodnjem okolju `itemize` uporabite ukaz `\url` na obeh spletnih naslovih
...
% oznaka za sklic je \ref !!!
% če želimo pa dati oznako, pa se da \label !!!
...
% Začetek magičnega kvadrata
   ...
   \begin{magic}{Magični kvadrat reda 3}{3}{magicni kvadrat reda 3}
      \label{table:mag3}
         8 & 1 & 6 \\\hline
         3 & 5 & 7 \\\hline
         4 & 9 & 2 \\\hline
...
\begin{figure}[!ht]
   \centering
   \caption{Pasijonska fasada, Sagrada Familia}
...
% Začetek dokaza (proof nam ni treba definirati v preambuli. ker je že vključen v paletu amsthm)
   \begin{proof}
      V normalnem magičnem kvadratu reda $n$ je vsota vseh nastopajočih
      števil (glej \ref{eq:numbers} na strani \ref{eq:numbers}) enaka
...
\begin{table}
   \centering
   \caption{število različnih magičnih kvadratov}
